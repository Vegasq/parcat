...
- [x] Manual test: Run full test suite with go test -v ./query/...
- [x] Run full test suite: go test ./...
- [x] Run linter: go vet ./...
- [x] Verify test coverage: go test -cover ./query/... (target 85%+)
- [x] Check coverage report: go test -coverprofile=coverage.out ./query/... && go tool cover -html=coverage.out

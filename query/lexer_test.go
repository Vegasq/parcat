...
func TestLexer_Delimiters(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expected: []Token{
				{Type: TokenIdent, Value: "col1"},
				{Type: TokenComma, Value: ","},
				{Type: TokenIdent, Value: "col2"},
				{Type: TokenComma, Value: ","},
				{Type: TokenIdent, Value: "col3"},
				{Type: TokenEOF, Value: ""},
			},
		},
		{
		...
		{
			name:  "AS keyword",
			input: "col1 AS alias1",
			expected: []Token{
				{Type: TokenIdent, Value: "col1"},
				{Type: TokenAs, Value: "AS"},
				{Type: TokenIdent, Value: "alias1"},
				{Type: TokenEOF, Value: ""},
			},
		},
		{
			name:  "as keyword lowercase",
			input: "col1 as alias1",
			expected: []Token{
				{Type: TokenIdent, Value: "col1"},
				{Type: TokenAs, Value: "as"},
...
func TestLexer_ColumnProjection(t *testing.T) {
	input := "select name, age, UPPER(status) as status_upper from data.parquet"
